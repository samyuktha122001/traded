 ...
 */
const getData = (baseUrl, userApiKey, name, amount, unitOfMeasure) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const templateId = '026d189e-37ed-4dff-ae01-a47c468bb21e';
    const templateResponse = yield axios_1.default.get(`${baseUrl}/popcodetemplates/${templateId}`);
